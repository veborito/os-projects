...
public interface CommandsFromWindow extends Remote {
	 ...
	 */
	public boolean createNewRoom(String roomName) throws RemoteException;
	
	/**
	 * Send a new message to the server to propagate to all clients
	 * @param text The message to send
	 */
	public void sendText (String chatName, String message) throws RemoteException;
	 ...
	 */
	public Vector<String> getChatRoomsList () throws RemoteException;
	 ...
	 */
	public boolean joinChatRoom (String name) throws RemoteException;
	 ...
	 */
	public boolean leaveChatRoom (String name) throws RemoteException;
